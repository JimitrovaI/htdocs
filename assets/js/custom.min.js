$(function() {
    ...
    var i = function() {
        ...
        $(".navbar-brand span").hide(), $(".navbar-brand .DRI-logo").show(), $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), 
        $(".sidebartoggler i").addClass("ti-menu")) : ($("body").removeClass("mini-sidebar"), 
        $(".navbar-brand span").show(), $(".navbar-brand .DRI-logo").hide());
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $("body").removeClass("mini-sidebar"), $(".navbar-brand span").show(), $(".navbar-brand .DRI-logo").hide()) : ($("body").trigger("resize"), 
        $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), 
        $("body").addClass("mini-sidebar"), $(".navbar-brand span").hide(), $(".navbar-brand .DRI-logo").show());
