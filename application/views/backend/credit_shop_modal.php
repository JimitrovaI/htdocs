...
<div class="modal fade" id="creditshopmodel" tabindex="-1" role="dialog" aria-labelledby="creditshopModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            ...
            <form method="post" action="<?php echo base_url(); ?>/transaction/saveTransaction" id="creditshopform" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="control-label"><?php echo $this->lang->line('prices') ?> (<?php echo $this->lang->line('available_credit') ?>:<span class="modal_available_credit"></span>)</label>
