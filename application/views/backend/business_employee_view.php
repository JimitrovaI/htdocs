                                        ...
                                        <div class="col-md-8">
                                            <form class="row" action="save_employee" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <input type="text" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control form-control-line" placeholder="ID" name="em_code" value="<?php echo $basic->em_code; ?>" required>
                                                </div>
                                                <div class="form-group col-md-4 m-t-10">
                                                    <label><?php echo $this->lang->line('name') ?></label>
                                                    <input type="text" class="form-control form-control-line" placeholder="<?php echo $this->lang->line('full_name') ?> " name="full_name" value="<?php echo $basic->full_name; ?>" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> minlength="3" required>
                                                </div>
                                                <div class="form-group col-md-4 m-t-10">
                                                    <label><?php echo $this->lang->line('blood_group') ?> </label>
                                                    <select name="em_blood_group" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control custom-select">
                                                ...
                                                <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <select name="em_gender" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control custom-select">
                                                ...
                                                <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <input type="date" id="bs_em_birthday" name="em_birthday" class="form-control" placeholder="" value="<?php echo $basic->em_birthday; ?>">
                                                </div>

                                                <div class="form-group col-md-4 m-t-10">
                                                    <label><?php echo $this->lang->line('phone') ?> </label>
                                                    <input type="text" class="form-control" placeholder="" name="em_phone" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> value="<?php echo $basic->em_phone; ?>" minlength="10" maxlength="15" required>
                                                </div>
                                                <?php if ($this->session->userdata('user_type') == 'SUPER ADMIN') { ?>
                                                    <div class="form-group col-md-4 m-t-10">
                                                ...
                                                <div class="form-group col-md-4 m-t-10">
                                                    ...
                                                    <input type="email" id="bs_em_email" name="em_email" class="form-control" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> value="<?php echo $basic->em_email; ?>" placeholder="email@mail.com" minlength="7" required>
                                                </div>
                                                <div class="form-group col-md-4 m-t-10">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row" action="save_address" method="post" enctype="multipart/form-data">
                                        <div class="form-group col-md-12 m-t-5">
                                            ...
                                            <textarea name="address" value="<?php if (!empty($permanent->address)) echo $permanent->address  ?>" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control" rows="3" minlength="7" required><?php if (!empty($permanent->address)) echo $permanent->address  ?></textarea>
                                        </div>
                                        <div class="form-group col-md-6 m-t-5">
                                            <label><?php echo $this->lang->line('city') ?></label>
                                            <input type="text" name="city" class="form-control form-control-line" placeholder="" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> value="<?php if (!empty($permanent->city)) echo $permanent->city ?>" minlength="2" required>
                                        </div>
                                        <div class="form-group col-md-6 m-t-5">
                                            <label><?php echo $this->lang->line('country') ?></label>
                                            <input type="text" name="country" class="form-control form-control-line" placeholder="" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> value="<?php if (!empty($permanent->country)) echo $permanent->country ?>" minlength="2" required>
                                        </div>
                                        <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                        <?php } else { ?>
                                            <div class="form-actions col-md-12">
                                    ...
                                    <form class="row" action="save_address" method="post" enctype="multipart/form-data">
                                        <div class="form-group col-md-12 m-t-5">
                                            <label><?php echo $this->lang->line('address') ?></label>
                                            <textarea name="address" value="<?php if (!empty($present->address)) echo $present->address  ?>" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control" rows="3" minlength="7" required><?php if (!empty($present->address)) echo $present->address  ?></textarea>
                                        </div>
                                        <div class="form-group col-md-6 m-t-5">
                                            <label><?php echo $this->lang->line('city') ?></label>
                                            <input type="text" name="city" class="form-control form-control-line" value="<?php if (!empty($present->address)) echo $present->city  ?>" placeholder=" City name" minlength="2" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> required>
                                        </div>
                                        <div class="form-group col-md-6 m-t-5">
                                            <label><?php echo $this->lang->line('country') ?></label>
                                            <input type="text" name="country" class="form-control form-control-line" placeholder="" value="<?php if (!empty($present->address)) echo $present->country  ?>" minlength="2" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> required>
                                        </div>
                                        <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?>
                                        <?php } else { ?>
                                            <div class="form-actions col-md-12">
